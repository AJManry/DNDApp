...
export const scenes: Scene[] = [
  {
    id: 's1-festival',
    act: 1,
    title: 'The Festival That Cannot Start',
    minuteStart: 0,
    minuteEnd: 10,
    mapId: 'map-kakariko',
    npcs: ['Villagers', 'Miller’s family', 'Cuccos'],
    summary: 'Kakariko’s harvest feast is set and stalled. Players arrive, look around, and feel the demon melody in the air.',
    boxedText:
      'Kakariko should be loud. Harvest lanterns hang from every eave, but they do not stir. The windmill turns as if someone is pushing it against a current. On the dirt square, tables are set for a feast no one is eating: roasted goat gone cold, round breads, a pyramid of red apples that nobody has touched. People speak in short, careful bursts, then stop, as if the air is humming something they do not want to finish. A cucco pecks a fallen lantern and the sound comes late. Above the old stone well, a single blue fairy hangs in the air, pulsing against a bruise-colored fog. Beyond the last fence, the tree line is wrong.',
    whatsHappening:
      'Ganondorf played a demon melody in the Sacred Realm. The tune has reached Kakariko as twilight fog and a stall in every ordinary job: mills, harvests, talk. This is not grief for a funeral. It is a kingdom being overwritten. Give each player thirty seconds in the square: what did they notice first — the fog’s hum, Navi’s spark, the twilight at the trees, or someone they love standing too still? Let them be Hylians, Sheikah, Kokiri, Gorons, Zora, Gerudo, Rito, or dream-called strangers. The miller’s child is not in the square. Nobody wants to be the first to say that out loud.',
    dmNotes:
      'Do not start a fight. Do not explain the plot. Ask, listen, then walk them toward the well. Rumor table (roll or offer): (1) the miller’s child wandered toward the Lost Woods at noon and has not come back; (2) Impa has not slept in three nights; (3) Bokoblin drums last night, far and flat; (4) the well water tastes like old rupees and rain; (5) Sheikah travelers passed through and would not stay; (6) a Gerudo merchant swears the desert wind has started humming the same wrong tune. If a PC shops: general store has rations, torches, 50 feet of rope; the tinker can mend an ocarina; The Second Note tavern is open but the bard’s lute is in its case. A kind word to a villager now pays off at dawn.',
    options: [
      {
        ...
        success:
          'The stall is not grief. A low, wrong tune rides the fog. People keep almost starting work, then stop. Navi’s glow fades in time with the fog at the tree line.',
        failure:
    ...
    skillChecks: [
      {
        ...
        ability: 'Insight or Perception',
        success:
          'The stall is not grief — a wrong tune rides the fog. People keep almost starting work, then stop.',
  ...
  },
  {
    ...
    mapId: 'map-kakariko',
    npcs: ['Impa', 'Navi'],
    summary: 'Impa gives the Ocarina of Time, Navi, and a leaf-map. Charge it at the temples, then play it against the demon melody.',
    boxedText:
      'An elder Sheikah in white and deep red sits on the well’s lip, the Ocarina of Time across her knees like a tool she can no longer use. The blue fairy darts to your shoulders, rings once like a glass tapped with a fingernail, and settles. “Hey! Listen!” she chimes, smaller than the stories. Impa’s voice is warm and precise, not a riddle. “I am Impa, of the Sheikah. This is Navi. Ganondorf played a demon melody in the Sacred Realm. Twilight is that tune spreading. Only this ocarina can break it — and only after you imbue it with power from the temples. If Hyrule waits too long, the kingdom will finish his melody for him.” She does not stand. Her hands, you notice, shake too badly to cover the ocarina’s holes.',
    whatsHappening:
      'Impa is Princess Zelda’s shadow and Kakariko’s sage. She failed to notice Ganondorf’s move until the melody was already in the fog, and she will not hide that. She cannot enter the Forest Temple: shame, age, and a tremor. Navi can answer one yes/no per scene (bright = yes, dull = no, split tone = complicated). The ocarina goes to whoever first offers to help, or to the Wisdom PC (often Sheik). Impa sketches a leaf-map: Lost Woods shrines, Forest Temple, Sacred Realm stones — each a charge the ocarina still needs. She warns: do not rest in the Lost Woods after dusk. If Sheik is at the table, Impa will not unmask Zelda unless the player does. She will answer honest questions; she will not give a lecture if the table wants to move.',
    dmNotes:
      'Let them ask. Good answers: the ocarina is empty until the temples charge it; playing it now can still open Kokiri doors; Ganondorf is Gerudo and young in the face; the Forest Temple still has keys and a living guardian; the miller’s child is a sequel hook unless they insist on a glance (Survival DC 14 on the gold trail finds a wooden horse, not the child). Potions: 3 red (2d4+2). If nobody volunteers, Impa puts the ocarina in the nearest PC’s hands and says “Then you will have to learn to play.”',
    ...
    options: [
      {
        ...
        success:
          'She does. Courage left, Wisdom ahead, Power right. “Each shrine puts power into the ocarina. Saria’s trick still holds: the loud trails lie.”',
      },
      {
        name: 'Press Impa on Ganondorf',
        text: 'Why a melody instead of a throne? Why twilight?',
        dc: 12,
        ability: 'Insight or History',
        success:
          '“He was born in the desert while we fattened on the Goddess’s gift. He found a demon tune that binds a kingdom faster than a siege.” She will not call him a pig-demon. Not yet.',
        failure:
      ...
      },
      {
        ...
        text: 'In calm air, playing it needs no check. In a crowd it is DC 10 Performance.',
        success:
          'Lanterns twitch. The fog’s hum skips a beat. Impa almost smiles. “It still works as a key. It will not break his melody until the temples charge it.”',
        failure:
          'A cracked tone. Villagers flinch. Navi dimmed for a breath. No Clock tick — not yet — but Impa takes the ocarina back for a moment and shows the fingering.',
      },
    ],
  },
  {
    ...
    summary: 'Tutorial fight. Three Poes climb the well to eat Navi’s light and feed the demon melody. Protect Navi.',
    boxedText:
      'The well-water goes black, as if someone blew out a color. Three lanterns of bruised-purple light peel out of the shaft, humming Ganondorf’s melody a half-step off — Poes, the hungry dead of twilight, faces like masks held too close to a candle. Villagers stumble back from the feast tables. A dropped apple hits late. Navi’s glow gutters. Impa’s voice is suddenly a commander’s, the tremor gone for ten seconds: “They are feeding his tune. Do not let them touch the fairy. Steel is fine. The ocarina is better. Do not follow them down the well.”',
    whatsHappening:
    ...
    options: [
      ...
      },
      {
        ...
        failure: 'The tone cracks. That Poe has advantage on its next attack against the player.',
      ...
      },
      {
        ...
        text: 'Dash toward the fields with a light or a shout. Poes follow the loudest spark.',
        dc: 13,
    ...
    skillChecks: [
      {
        name: 'Play the ocarina against a Poe',
        dc: 12,
        ability: 'Performance or Constitution',
        success: 'One Poe unravels. Others have disadvantage this round.',
        failure: 'Cracked tone. That Poe has advantage on you next attack.',
      },
    ],
  },
  {
    ...
    summary: 'Keese boil out of the stalled windmill. A short second fight before the gold trail. Skip if the well already ran long.',
    boxedText:
      'The windmill’s vanes tick once, fighting the fog. From the dark throat of the mill, four winged shapes peel out — Keese, leather and tooth, eyes like cheap amethyst. One of them trails a thread of orange, a Fire Keese that has been nesting in the miller’s lamp oil. The miller’s wife makes a sound that is almost a scream and then remembers the village is trying not to feed whatever is humming in the well. Impa’s commander-voice is gone; she is an elder again, pointing at the square. “They followed the Poes up. Do not let them into the feast tables. The mill still has to turn at dawn.”',
    whatsHappening:
      'Main-path fight, two rounds. 4 Keese (one Fire Keese). Open square, windmill as three-quarters cover from the ground, feast tables still difficult terrain if flipped. They want lamp oil, livestock, and anything that still glows — Navi included, but they are dumber than Poes. If a Fire Keese hits a lantern or a PC carrying a torch, that light goes out or a 5-foot spark lands (1 fire damage, trivial). After the fight the gold trail to the Lost Woods is obvious. Impa still will not leave the well. Playing the ocarina (DC 12) drops two ordinary Keese; the Fire Keese needs steel or water.',
    dmNotes:
    ...
    options: [
      {
        ...
        success: 'They drop. The gold trail brightens. The miller mouths thank you and cannot find the words.',
      },
      {
      ...
      },
      {
        ...
        text: 'Ocarina or a loud clap. Keese hate a clean tone from the ocarina.',
        dc: 12,
        ability: 'Performance or Constitution',
    ...
    skillChecks: [
      {
        name: 'Play the ocarina against Keese',
        dc: 12,
        ability: 'Performance or Constitution',
  ...
  },
  {
    ...
    npcs: ['Navi'],
    summary: 'The gold trail splits at standing stones: Courage, Wisdom, Power. Each shrine charges the ocarina. Two trails if time is tight; three ticks the Clock.',
    boxedText:
      'The Lost Woods return sound a breath late. Your footsteps arrive after you. Birdsong answers in a key you do not know. Moss hangs like curtains that were never woven. The gold trail splits around a ring of standing stones older than Kakariko: a Master Sword shrine to the left (Courage), a Sheikah-eye shrine ahead (Wisdom), a Goron-gauntlet shrine to the right (Power). Each shrine can put a first charge into the ocarina. Somewhere deeper, wooden chimes turn though there is no wind. Navi hovers at the fork and does not choose for you. “Hey… the quiet way is the real way. Loud trails lie.”',
    whatsHappening:
      'Each trail is a five-minute vignette, not a hex crawl. Completing a trail that matches a PC’s Triforce virtue grants that PC inspiration and imbues the ocarina with that shrine’s power. Taking all three advances the Twilight Clock by 1 — if you are behind, say so and offer two. False trails echo louder; the true path is quieter (Saria’s trick). If they split the party, Navi’s gold trail fades in ten minutes and someone will loop. Koroks watch from the roots and do not yet speak. Howls answer a smashed cedar — Wolfos later, Bokoblins after the meadow.',
    dmNotes:
    ...
    options: [
      ...
      },
      {
        ...
        text: 'The loud left path is a lie. Track moss-arrows, Navi, or the quiet fork.',
        dc: 13,
      ...
      },
      {
        ...
        text: 'If the session is behind, Impa’s map still works with two shrine charges.',
        success:
          'Skip the third shrine. No Clock tick for “taking all three.” You will feel the missing virtue at the Sacred Realm stones — still solvable. The ocarina is undercharged, not useless.',
      },
    ],
    skillChecks: [
      {
  ...
  },
  {
    ...
    boxedText:
      'Faces bloom in the root-tangle: small, leaf-masked, eyes like wet river stones. They smell like crushed mint and damp pockets. A Korok elder no taller than a boot holds up a seed as if it were a lantern. “Yahaha! Ocarina people,” they creak, delighted and grave at once. “Give us a true name, a true joke, or a true hunger, and we show the Forest Meadow. Give us a lie, and we show you the long way, where the fog has teeth. We are not judges. We are gardeners. Gardeners know which stories grow.” Behind them, a dozen more Koroks peek, then hide, then peek.',
    whatsHappening:
      'Social scene, not a riddle with one answer. A sincere offering — a ration, a tune on the ocarina, a secret, Saria’s Korok seed, the miller’s child’s name spoken kindly — succeeds without a roll. Deception DC 14 can fake a “true” gift; the Koroks remember and will not mark the Quiet Roots alcove. On a kind success they also mark a secret alcove in the Forest Temple (Room of Quiet Roots — a small key). On a lie or a threat, Twilight Clock +1 and they vanish; the meadow is still findable with DC 14 Survival. Combat against Koroks is possible and ugly: they melt, Clock +1, and Navi will not speak to the attacker until the temple door.',
    dmNotes:
    ...
    options: [
      {
        ...
        text: 'A real name, a real joke, a real hunger, a ration, a tune, a seed.',
        success:
      ...
      },
      {
        ...
        failure: 'They are polite. “Almost.” Try a name or a ration; no Clock.',
      },
      {
  ...
  },
  {
    ...
    summary: 'Four chimes, one cracked. Strike low → middle → high. Courage writes itself in gold and charges the ocarina.',
    boxedText:
      'A clearing like a held breath. Four wooden chimes hang from a living arch: low, middle, high, and a cracked fourth that does not belong — its wood is the color of a bruise, and it turns the wrong way in a wind you cannot feel. Stone underfoot is carved with the Kokiri’s emerald. When the wrong chime is struck, the forest answers with a laugh that is not a laugh. Fireflies hold still in the air, waiting. Navi drifts to the lowest living chime and rings a note so small you might miss it. The cracked chime hums the demon melody, hungry for a hand.',
    whatsHappening:
      'Puzzle: the cracked chime is twilight-tainted. Players must strike the three living chimes in rising order — low, middle, high — the old Kokiri phrase Saria still uses. Clues are generous. Wrong order twice: 2 Poes drift in (or just Clock +1 if the well fight ran long). Success writes gold in the air: COURAGE IS THE STEP YOU TAKE BEFORE THE PATH APPEARS, and the ocarina takes a Courage charge from this shrine. Any PC can spend this Triforce of Courage once to automatically succeed a save against fear, or to add 1d8 to a heroic movement (jump, dash through gloom, hold a door). The cracked chime can be taken as a sad trophy; it is not a weapon unless a PC insists (then it is a club that hums the demon melody, and Navi hates it).',
    dmNotes:
      'If they smash all four, the Courage charge still appears after a Clock tick — fail forward. If a bard or Saria is present, they may know the phrase and skip the trial by playing it on the ocarina (Performance DC 10). Do not let this eat twenty minutes.',
    ...
    options: [
      {
        ...
        success: 'Gold light. Triforce of Courage. The ocarina takes a shrine charge. Fireflies move again. The gold trail thickens toward the temple.',
      },
      {
      ...
      },
      {
        ...
        text: 'Harp, ocarina, or voice. The meadow wants the rising phrase more than it wants wood.',
        dc: 10,
        ability: 'Performance',
  ...
  },
  {
    ...
    summary: 'Three Bokoblins paid to keep the gold trail empty. They will take a deal. Talk is a way through, not a skip of the scene.',
    boxedText:
      'The gold trail tightens between two nurse-logs. Pig-ivory horns. Three (or four) hunched Bokoblins in scrap-hide step from the ferns, eyes reflecting purple like cheap glass. Their leader wears a necklace of stolen wind-chimes — Kakariko’s, if anyone looks. He holds up a palm, almost polite. “The dusk-king pays for empty roads,” he grunts. “You are very loud. We can take your ocarina-toy and let you walk around the long fog. Or we can see if Hylians still bleed green.” Behind him, a stream, two trees, and a fourth Bokoblin who would rather be somewhere else.',
    whatsHappening:
  ...
  },
  {
    ...
    npcs: ['Navi'],
    summary: 'Two Lizalfos guard the vine door for twilight. Playing the ocarina still opens the lattice — and can send the lizards home.',
    boxedText:
      'The Forest Temple rises from the Lost Woods like a stone seed that forgot to stop growing. Stairs climb between buttresses of root and masonry. Owls that are not quite owls watch from niches and do not blink. The great door is a lattice of sleeping vines, each as thick as a wrist, breathing so slowly you could mistake it for stone. In the lintel, a leaf-shaped recess the size of an ocarina’s mouth. Two Lizalfos cling to the buttresses like wet jewels — chameleon hide, spears, tongues tasting the gold trail. They were paid to keep the ocarina out. The air smells of wet iron, crushed mint, and old incense. Someone has carved, very small, at the foot of the stair: WE KEPT THIS DOOR. Navi rings once, uncertain. “Hey. Knights used to live here. The lizards did not.”',
    whatsHappening:
      'Playing the Ocarina of Time opens the vine door with no check in calm air — and the Lizalfos must make a DC 12 Wisdom save or flee into the moss (they were hired to keep the instrument out; an ocarina that works is above their pay). If the play fails or nobody uses it, 2 Lizalfos fight on the stairs: high ground, vine cover, tongues pulling PCs off steps. Alternatives exist because tables poke doors. Inside: dim green light, dust, a mural of three sages offering temple-power to an ocarina bound for the Sacred Realm. History DC 13: the “heroes” look like ordinary people — a farmhand, a scholar, a Goron smith. If they already have the Courage sigil, pressing it to the recess also opens the door. Forcing it is possible and loud — the Lizalfos have advantage on their first attacks if the vines scream.',
    dmNotes:
      'This is a door fight, not a second dungeon. Two rounds. If they open with the ocarina, you may still let one Lizalfos be stubborn (the leader) so steel happens — or honor the skip. Once inside, let them feel the dungeon is a tool for charging the ocarina with Forest Temple power. Do not start the hall puzzle until they have looked at the mural — thirty seconds of story pays off at the Shade.',
    options: [
      {
    ...
    skillChecks: [
      {
        ...
        ability: 'History',
        success:
          'The heroes are ordinary: farmhand, scholar, Goron smith. The temple was built for people like you. This matters when the Shade asks for a password.',
  ...
  },
  {
    ...
    summary: 'Mini-boss. An old Hero of Time who kept his post. Playing the ocarina can turn this into a funeral instead of a slaughter.',
    boxedText:
      'The barracks were for living Knights of Hyrule. Bedrolls have become dust. A rack of spears still waits for hands. What remains is a captain in rusted green-gold plate, skull bright as a lantern — the Hero’s Shade, a previous chosen one who never laid down the sword. He salutes with a blade that still remembers courtesy. When he speaks, you hear a young man and a very old one using the same mouth. “The usurper promised we would keep our posts,” he says, almost grateful. “I have been keeping them so long I forgot the password was the ocarina.” He sets his helm. “If you are the ones who will charge it, prove it. If you are thieves, I will stop you. I was kind, once. Kindness is heavy. I put it down.”',
    whatsHappening:
      'He is honorable. If the party plays the ocarina before anyone attacks, he has disadvantage on his first turn and will accept a surrender-parley at 15 hp: he yields the Boss Key and asks them to bury his name as a Hero of Time, not a ghost. Otherwise he fights until destroyed and uses Rally the Hollow once. Afterward: Boss Key, and a mural showing Ganondorf as a young Gerudo king who locked himself in the Sacred Realm “to keep the Triforce safe from war” — tragedy, not cartoon evil. Impa trained this man. If they bring his rest home at dawn, she weeps once, then bakes bread. A +1 rusted longsword that sheds green light (10 ft) is a Virtue: Courage weapon; it wants to be laid down eventually.',
    dmNotes:
      'If they only murder him, the mural still shows. The sword still drops. Navi is quieter. Parley is the better story and not a “skip.” The password he forgot is playing the ocarina, showing a Triforce charge, or “we kept this door” from the stair.',
    treasure:
    ...
    options: [
      {
        ...
        text: 'Play the ocarina, show a Triforce charge, or “we kept this door.” Then talk or fight with his respect.',
      ...
      },
      {
        ...
        success: 'Fight him as a solo with the others aiding (Help action = Performance DC 12 to play the ocarina). At 15 hp he still yields if they offered the ocarina at any point.',
      },
      {
        name: 'Full fight',
      ...
      },
      {
        ...
        text: 'Persuasion after playing the ocarina, or after he is bloodied.',
        dc: 14,
  ...
  },
  {
    ...
    summary: 'Boss or ocarina challenge. The construct guards the Forest Temple charge. Wisdom blooms when it kneels. Heart Container. Stairs to the Sacred Realm.',
    boxedText:
      'The inner sanctum is a circular garden under a cracked dome, stars showing through like shy rupees. A colossus of vine, temple-stone, and armored spider kneels as if in prayer — Armogohma, a blade of living green fused to its legs, eyes shut. The Boss Key-hole is a flower in the floor. When it turns, the construct’s eyes open the color of old rupees. It was built to hold the Sage of Forest’s power until an ocarina came to take it. Twilight taught it that everything moving is a thief. It does not roar. It inhales, and the garden’s grass leans toward it. Navi, very small: “Hey. It used to listen. We can remind it. Or we can break it. Breaking is louder.”',
    whatsHappening:
      'If time is short: skip the fight — an ocarina skill challenge (3 successes before 3 failures, DC 13 Performance, Arcana, or Persuasion; playing the ocarina and Triforce virtues count) soothes it and it offers the Forest Temple charge. Full fight: Armogohma, remind them Vineheart (ocarina gives it disadvantage on its next attack). At 0 hp it does not explode; it kneels again and the Triforce of Wisdom blooms in its chest: WISDOM IS THE LISTENING THAT MAKES A PATH KIND. The ocarina takes the temple’s power. Heart Container blessing on the party if they do not already have one. A stair of roots opens toward the Sacred Realm. A potion of greater healing in the rib-garden. Killing it and soothing it grant the same treasure; the difference is how Navi looks at them.',
    dmNotes:
      'Do not run a 40-minute boss if you are at minute 160. The skill challenge is the designed skip. If they fight, keep Vineheart loud. Fail the challenge 3 times: it wakes angry and you fight anyway, but it has already taken 20 damage from doubt.',
    treasure: 'Triforce of Wisdom; Heart Container; 1 potion of greater healing in the construct’s rib-garden.',
    options: [
      {
        name: 'Soothe it with the ocarina',
        text: '3 successes before 3 failures, DC 13 Performance / Arcana / Persuasion. Ocarina auto-counts as a success once.',
        success: 'It kneels. Forest Temple charge. Wisdom. Stairs. No Clock.',
        failure: 'It fights, already cracked (start at −20 hp). The charge still comes when it kneels at 0.',
      },
      {
      ...
      },
      {
        ...
        ability: 'Persuasion',
        success:
          'It yields the Forest Temple charge and stays kneeling as a statue. Sequel: someone may have to come back. Wisdom still blooms.',
        failure: 'It does not trust a mortal with a watch this long. Choose fight or the ocarina challenge.',
      },
    ],
    skillChecks: [
      {
        name: 'Ocarina skill challenge',
        dc: 13,
        ability: 'Performance, Arcana, or Persuasion',
        success: '3 successes: it yields and offers Wisdom.',
  ...
  },
  {
    ...
    options: [
      ...
      {
        name: 'Ask what the last charges are',
        text: 'Navi, Sheik, Arcana, or a paladin’s oath.',
        dc: 12,
        ability: 'Arcana or Insight',
        success: 'Power is what you give away at the stones. There is no chest. The ocarina still needs those last temple-gifts.',
      ...
      },
      {
        ...
        success:
          '“Finish charging it. I am so tired of half-measures.” Then he waits. No initiative yet.',
      },
      {
  ...
  },
  {
    ...
    npcs: ['Navi'],
    summary: 'Bubbles and a Stalfos on the Sacred Realm stair — leftover twilight Ganondorf would not catch. A last fight before the trials.',
    boxedText:
      'The pale stair to the dais is a throat of wind. Three skulls in shells of cursed fire — Bubbles — bounce the steps as if the stone were a drum. Behind them, a Stalfos in rusted Hylian plate plants a shield and waits, courteous as the Shade was, empty as he is not. They hum Ganondorf’s demon melody a half-step off, the same insult as the Poes, louder because the Sacred Realm has nowhere to hide an echo. Ganondorf, still a silhouette on the gold, does not look down. Navi shakes so hard her light stutters. “Hey. Those are scraps of his tune he wouldn’t take. If we don’t stop them, they’ll stop us.”',
    whatsHappening:
      'Main-path fight. 3 Bubbles (two fire, one ice) and 1 Stalfos. Terrain: stairs are difficult terrain going up; a missed melee attack against a Bubble from below has a 1-in-6 chance to send the attacker prone down a step (1d4 bludgeoning, flavor). Bubbles curse on a hit (disadvantage on next attack; playing the ocarina clears it). The Stalfos parries once per round and tries to hold the landing. They are leftover twilight, not Ganondorf’s honor guard — if the party plays the ocarina as an action, one Bubble unravels. At 0 hp they pop into moths. Afterward the standing stones wake. If you are past minute 185, skip: one Bubble pops on the stair, the Stalfos salutes and sits down like a dropped suit, trials begin.',
    dmNotes:
      'Two or three rounds. Do not turn this into a second boss. The Stalfos will yield if someone names the Shade or says “we kept this door” (Persuasion DC 12) — it was a knight once. Bubbles do not parley. A Fire Bubble that dies next to a PC can ignite a cloak (1 fire, put out as an action). This fight exists so Ganondorf is not the only steel in Act 4.',
    ...
    options: [
      {
        ...
        text: '3 Bubbles + 1 Stalfos. The ocarina pops Bubbles. Stalfos holds the landing.',
        success: 'The stones wake. You arrive loud, which Ganondorf prefers.',
      },
      {
        name: 'Name the knight',
        text: 'The Shade’s rest, “we kept this door,” or a salute.',
        dc: 12,
        ability: 'Persuasion or Religion',
      ...
      {
        name: 'Play the ocarina on the stair',
        text: 'Ocarina as an action. One Bubble per success.',
        dc: 12,
        ability: 'Performance or Constitution',
        success: 'One Bubble unravels. Repeat if you want to spend the fight on the instrument.',
        failure: 'The demon melody gets louder. Bubbles have advantage on their next ram.',
      },
      {
        name: 'Skip if behind',
    ...
    skillChecks: [
      {
        name: 'Pop a Bubble with the ocarina',
        dc: 12,
        ability: 'Performance or Constitution',
  ...
  },
  {
    ...
    summary: 'Courage steps into air. Wisdom answers what cannot be stolen. Power pays a price. Together they finish charging the ocarina.',
    boxedText:
      'The standing stones wake without thunder. Gold asks for a step into empty air over the drop — Courage, a path that will not exist until a foot is already falling. Teal asks a riddle in the wind, in Impa’s cadence and a child’s: “What gift cannot be stolen?” — Wisdom. Crimson asks for a price you will feel in the morning: blood, a treasured item, or a promise that will hurt later — Power. These are the last temple-gifts. Pour them into the ocarina. Ganondorf does not interrupt. His helm is in his hands. He wants the instrument finished so he can take the Triforce whole, the way a drowning man wants the last breath in the room. Navi rings three times, then is quiet, because this part is not a fairy’s.',
    whatsHappening:
      'Fast. Ten minutes, not a second dungeon. Courage: step off; a bridge of light appears after the first foot falls (or Athletics DC 14 to leap to a spur if they refuse faith). Wisdom riddle answers: a gift, a party, a name spoken truly, listening, love, the Goddess herself, time given away — reward sincerity. “A lock,” “a king,” “me,” “steel” fail; another PC may try; Navi can hint once (“Hey. Not a thing you keep.”). Power: 1d6 damage, or sacrifice a magic item (the Shade’s sword is a beautiful awful choice), or swear a geas-like promise (DM’s sequel hook: return to Ganon’s Castle, find the child, carry a charge to the desert). Completing all three writes the Triforce of Power in the air: POWER IS THE GIFT YOU GIVE AWAY, and the ocarina is fully charged. The matching-virtue PC does not have to take their own stone; the table can mix.',
    dmNotes:
      'If they skip a stone, the ocarina is still playable against the demon melody with disadvantage on the first two ocarina checks in the fight. Do not stop the session here. Ganondorf waits one round of gloating after the last charge, then initiative unless they speak first.',
    options: [
      {
      ...
      },
      {
        ...
        text: 'What gift cannot be stolen?',
        dc: 0,
        ability: 'Wisdom (roleplay)',
        success: 'A gift, a party, listening, a true name, love, time given. The stone warms.',
      ...
      },
      {
        ...
        success: 'Crimson writes POWER IS THE GIFT YOU GIVE AWAY. The ocarina is fully charged.',
      },
      {
        name: 'Let one PC take all three',
        text: 'Possible. Lonely. The stones accept it and the later ocarina checks are harder (DC 14) because the party was refused.',
        success: 'The charges appear. Ganondorf looks almost sorry for them.',
      },
    ],
    skillChecks: [
      {
        ...
        dc: 0,
        ability: 'Wisdom (roleplay)',
        success: 'The stone accepts a true answer about gifts, a party, listening, or names.',
  ...
  },
  {
    ...
    npcs: ['Ganondorf', 'Navi'],
    summary: 'Climax. Fight and ocarina together. Six successes to break the demon melody. He can be killed, spared, or turned into a warden.',
    boxedText:
      'Ganondorf lifts his helm. The Gerudo face beneath is young and exhausted, the desert still in the corners of his eyes. “I was born where the Goddess’s gift was a rumor,” he says, not unkindly. “Every generation treats the Triforce like a prize. So I played a demon melody into twilight, where nothing ages and nothing is asked to be a hero. Play your ocarina if you must. I will drown it with the same tune, and Hyrule will finally stop — no more chosen children, no more failures, no more dawn that demands a sword.” The dais cracks. Purple storm stands up like a second king. Navi does not say hey. She just holds still, shaking, and waits for you to play.',
    whatsHappening:
      'Two layers at once. Combat: Ganondorf stat block, phase 1 knight, phase 2 Ganon-beast if the Clock is 6 at start or when he hits half hp. Parallel skill challenge: the charged Ocarina of Time needs 6 successes to break the demon melody before he hits 0 or the table would tick a 7th Clock (it cannot — instead, at 3 ocarina failures he auto-casts Unmake the Charge). Any PC can use an action to play the ocarina (Performance, Constitution, a spell slot, a spent Triforce virtue) DC 13 for a success. Combat and the ocarina interleave; do not make it “fight then a concert.” Redeem him: Persuasion DC 15 once when he is below 30 hp and they have at least 3 ocarina successes — he hesitates (skips a turn, drops resistance). Killing him ends the twilight. Sparing him: he becomes the Sacred Realm’s new warden, a tragic NPC — and Ganon’s Castle still waits as a sequel. If they only fight and never play the charged ocarina, the twilight thins but does not heal; dawn is grey and the Clock’s scars stay.',
    dmNotes:
      'Track ocarina successes visibly (six stones, six marks). Remind them of Vineheart-style ocarina tricks and spent virtues ignoring resistance. If the table loves talking, let a whole round be argument; he will answer. He is a thesis, not a pig, until phase 2. Phase 2 can still be redeemed if they already had 3 ocarina successes — harder Persuasion DC 17.',
    treasure:
      'Twilight Blade (rare, +1 longsword, 1d4 necrotic; once/day dim twilight 20 ft). Ganondorf’s helm (story). The Green of Hyrule restored — if the ocarina finished the job.',
    options: [
      {
        name: 'Interleave steel and the ocarina',
        text: 'The designed climax. 6 ocarina successes, DC 13, while he tries to drown the instrument.',
        success: 'Twilight ends. Choose kill, spare, or warden.',
      },
      {
        name: 'Redeem',
        text: 'Below 30 hp (or beast at half) and ≥ 3 ocarina successes. Tell him a locked kingdom is not a victory.',
        dc: 15,
        ability: 'Persuasion (DC 17 in phase 2)',
        success: 'He skips a turn, drops resistance. Next ocarina check is DC 11. He may kneel if they offer him the warden’s post.',
      ...
      },
      {
        ...
        failure: 'If they never play the charged ocarina and lose, twilight keeps Kakariko. That is a hard end — offer one last play even in defeat.',
      },
      {
        name: 'Offer him the watch Armogohma had',
        text: 'A warden, not a king. Works best after redeem success.',
        success:
    ...
    skillChecks: [
      {
        name: 'Play the charged ocarina',
        dc: 13,
        ability: 'Performance, ocarina, spell slot, or spent virtue',
        success: 'One of six. The standing stones brighten. The demon melody skips.',
  ...
  },
  {
    ...
    summary: 'Coda. Green comes back. Ask each PC what they do with the first clear morning. Thank the table. End on something small.',
    boxedText:
      'The first color back is green so bright it hurts. Kakariko’s lanterns remember how to move. The windmill turns without fighting the fog. Cuccos complain, which is a kind of proof. Navi becomes, for a moment, a whole bright spark — then a small tired fairy again, curled in someone’s collar, too proud to say thank you. Impa is waiting on the road with bread that is finally warm, and with a look that is not a legend’s look. “You did not save a myth,” she says. “You saved a place that wanted to keep working.” Far north, Ganon’s Castle still wears a little shadow, like a bruise a body is allowed to keep. The ocarina is quiet in someone’s pack. That is enough.',
    whatsHappening:
      'Epilogue in 5–10 minutes. Go around the table: what do you do with the first morning the fog lifts? Eat, sleep, look for the miller’s child, refuse the Twilight Blade, give the Shade’s sword to Impa, stay, leave, kiss someone, do not. If Clock hit 6, a grove is gone and a child is still missing — bittersweet, not a gotcha; that child is a sequel, not a failure of tonight. Rewards: 700 XP each (or level 4 if you prefer a hard bump), Heart Container if unused, downtime in Kakariko. Sequel hooks to name out loud: the missing child in twilight; the Twilight Realm itself; Navi growing into a full sage; Ganon’s Castle; a Gerudo desert that still has not been given a gift. If they spared Ganondorf as warden, Impa will not thank them and will not condemn them. Thank the table. End on something small, not a lecture — a cucco, a windmill, a fairy saying hey one last time.',
    dmNotes:
      'Do not start a new dungeon. If someone wants to march on the Castle, Impa blocks the road with bread. “Tomorrow is work too.” Fade out.',
    options: [
      {
        name: 'Go around the table',
        text: 'One image each. No rolls unless someone insists on shopping.',
        success: 'The session has a shape. You can stop talking while the fog is still lifting.',
      },
      {
