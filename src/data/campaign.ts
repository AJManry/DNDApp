...
export const CAMPAIGN = {
  ...
  tone: 'Lyrical adventure across Hyrule: a frozen harvest, shrine trails, a temple with keys, steel between the verses, and a twilight duel in the Sacred Realm.',
  premise:
  ...
  howToRun: [
    ...
    'Keep the 3-hour clock honest. If you must cut fights, skip Keese at the mill, Wolfos in the gold grass, and the twilight choir on the stair — in that order. Armogohma can be a lullaby skill challenge. Talk can still walk through Bokoblins and Lizalfos. Do not start Ganon’s Castle tonight.',
  ...
  skipIfBehind: [
    ...
    'The Uncaught Measures (Act 4) — one Bubble pops, the Stalfos salutes, trials begin.',
...
export const acts = [
  ...
  },
  {
    ...
    minutes: '0:40–1:30',
    color: 'green',
    hook: 'Three shrine trails, Koroks, Saria’s Meadow, Wolfos, then Bokoblins.',
  },
  {
    act: 3 as const,
    title: 'Forest Temple',
    minutes: '1:30–2:45',
    color: 'moss',
    hook: 'Lizalfos at the vine door, keys, a Wallmaster over the gloom, the Hero’s Shade, Armogohma.',
  },
  {
    act: 4 as const,
    title: 'Sacred Realm',
    minutes: '2:45–3:30',
    color: 'twilight',
    hook: 'Twilight stair, a choir of Bubbles, Triforce trials, a duel-and-song with Ganondorf.',
  },
  {
    act: 5 as const,
