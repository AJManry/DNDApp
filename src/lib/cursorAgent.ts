...
export function buildCursorForgePrompt(userPrompt: string): string {
  return [
    ...
    'Give a Triforce virtue: Courage, Wisdom, or Power. Every character MUST have exactly two attacks and two spells (martial classes still get two Zelda-flavored spells).',
    'Inventory notes must include attack dice like “+5 to hit, 1d8+3 slashing.” Attacks and spells need hit, damage, and range so they print on the sheet.',
    ...
    '"attacks":[{"name":"Shortbow","hit":"d20+5","damage":"1d6+3 piercing","range":"80/320 ft","notes":"Two-handed."},{"name":"Shortsword","hit":"d20+5","damage":"1d6+3 piercing","range":"5 ft","notes":"Finesse."}],',
    '"spells":[{"name":"Hunter’s Mark","hit":"bonus action","damage":"+1d6 vs marked","range":"90 ft","notes":"1st-level slot."},{"name":"Hail of Thorns","hit":"DC 12 DEX","damage":"1d10 piercing","range":"5 ft of the target","notes":"1st-level slot."}],',
